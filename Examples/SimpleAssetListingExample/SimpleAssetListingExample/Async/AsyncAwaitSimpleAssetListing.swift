...
struct AsyncAwaitSimpleAssetListing: View {
    @ObservedObject var model = AsyncAwaitSimpleAssetListingModel()
...
@MainActor
class AsyncAwaitSimpleAssetListingModel: ObservableObject {
...
struct AsyncAwaitSimpleAssetListing_Previews: PreviewProvider {
    static var previews: some View {
        AsyncAwaitSimpleAssetListing()
    }
}
