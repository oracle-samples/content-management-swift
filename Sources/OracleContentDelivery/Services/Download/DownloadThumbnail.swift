...
public final class DownloadThumbnail: BaseDownloadService,
    ...
    internal typealias ServiceSpecificParameters  = DownloadThumbnailParameters
    public typealias ServiceReturnType            = DownloadThumbnail
...
internal class DownloadThumbnailParameters: SimpleDeliveryParameters {
    ...
    public init(identifier: String, fileGroup: String? = nil, advancedVideoInfo: EmbeddedAdvancedVideoInfo? = nil) {
    ...
    public convenience init(
        ...
        self.init(identifier: identifier, fileGroup: fileGroup, advancedVideoInfo: advancedVideoInfo)
